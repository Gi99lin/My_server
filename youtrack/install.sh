...
echo "2. In the wizard set Base URL to https://tracker.gigglin.tech and create the admin user."
echo "3. Add a Proxy Host in NPM: tracker.gigglin.tech -> youtrack:8080 (scheme http,"
